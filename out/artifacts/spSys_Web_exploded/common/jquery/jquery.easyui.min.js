...
(function($) {
	...
	$.fn.window.defaults = $.extend( {}, $.fn.panel.defaults, {
		...
		draggable : true,
		resizable : true,
		shadow : false,//取消所有shadow阴影 add by sunben
		modal : false,
		inline : false,
		title : "New Window",
		collapsible : true,
...
(function($) {
	...
	function _1ec(_1ed, _1ee, _1ef) {
		...
		win.window("window").css("top",'150px');//add by sunben 
...
(function($) {
	function init(_302) {
		...
		var _303 = $("<input id=\""+$(_302).attr("title")+"\" type=\"text\" class=\"searchbox-text\">")
				.appendTo(span);
		$("<span><span id=\"searchSpan\" onclick=\""+$(_302).attr("onclick")+"\" class=\"searchbox-button\"></span></span>").appendTo(
				span);
