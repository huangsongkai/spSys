	...
	<form id="pagerForm" action=""  method="post"  onsubmit="return navTabSearch(this);">    
		...
		<div class="pageFormContent" >
			<table class="searchContent"  width="100%" id="table1">							
				...
				<tr>
						<td>
						<input name="button" type="button"  onclick="showResult('param3');" value="查询" >
						</td>
				</tr>	
				
			</table>
		 </div>
			 <div  id="highchartDivCheck10" ></div>
	</form>
</div>
    <script language="javascript">
    $(function () {
     $('#highchartDivCheck10').highcharts({
            title: {
                text: ${name},
                x: -20 
            },
        ...
        function showResult(type1){
			...
			$("#highchartDivCheck10").loadUrl("listCheckAnalyse.do?type=score&checkId="+checkId+"&pkUnita="+pkUnita+"&pkUnitb="+pkUnitb+"&pkUnitc="+pkUnitc+"&pkUnitd="+pkUnitd+"&year="+year+"&type="+type+"&certType="+certType+"&yearTo="+yearTo,"", "");
        }
