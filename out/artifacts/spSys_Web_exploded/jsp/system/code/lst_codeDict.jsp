...
<jsp:include page="../../../common/head.jsp">
	...
	{  		
		if(obj!=null)
		{
			...
			{
				alert("所选字典码大类层级限定为"+levelTal+"级，不能向所选节点中添加子类！");
			}
		}
		else
		{
				...
				else
				{
					...
					else
					{
						if(confirm("确认删除？"))
						{
							...
							if(a=="ok")
								window.parent.frame_right.location.href="${ctx}/blank_common.jsp?title=数据字典管理";
	...
	function goback()
	{
		window.parent.location.href="list_CodeKind.do";
	}
</script>
	</head>
	<body>
	<div id="body_div">
	<w:ShowTitle name="字典明细">
