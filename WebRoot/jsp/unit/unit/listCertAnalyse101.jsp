	...
	<form id="pagerForm" action=""  method="post"  onsubmit="return navTabSearch(this);">    
		...
		<div class="pageFormContent" >
			<table class="searchContent"  width="100%" id="table1">							
			 ...
			 <div  id="highchartDivCheck80" ></div>
...
// Radialize the colors
    ...
    $('#highchartDivCheck80').highcharts({       
     //credits: '啊啊啊啊',
        //图表区选项
        ...
        function showResult(){
	       var pkUnita = $("#pkUnita").val();
			...
			$("#highchartDivCheck30").loadUrl("highchartDivCheck30.do?pkUnita="+pkUnita+"&pkUnitb="+pkUnitb+"&pkUnitc="+pkUnitc+"&pkUnitd="+pkUnitd+"&year="+year+"&certType="+certType+"&yearTo="+yearTo);  
        }
