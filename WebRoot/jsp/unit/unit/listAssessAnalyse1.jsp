		...
		<div class="searchBar" >
			<table class="searchContent"  width="100%" id="table1">							
				<tr>
					...
					<td class="left_align">
					<input id="statDateFromassess1" type="text"  value="${statDateFrom}" class="date" dateFmt="yyyy">至
					<input type="text" id="statDateToassess1"  value="${statDateTo}"  class="date" dateFmt="yyyy">
					</td>
			 ...
			 <div  id="highchartDivCheck5" ></div>   
	</form>
</div>
<script language="javascript">           
 $(function () {
        $('#highchartDivCheck5',navTab.getCurrentPanel()).highcharts({
            title: {
                text: ${name},
                x: -20 //center
            },
        ...
        function showResult(){  
        	var statDateFrom = $("#statDateFromassess1",navTab.getCurrentPanel()).val();
	        var statDateTo = $("#statDateToassess1",navTab.getCurrentPanel()).val();  
	        var selectMemberName = $("#selectMemberName1",navTab.getCurrentPanel()).val();         
			$("#highchartDivCheck5",navTab.getCurrentPanel()).loadUrl("listAssessAnalyse1.do?statDateFrom1="+statDateFrom+"&statDateTo1="+statDateTo+"&selectMemberName1="+selectMemberName);
        }
