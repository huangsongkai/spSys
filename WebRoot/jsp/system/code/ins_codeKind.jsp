...
<title>添加数据字典大类项</title>
</head>
<body>
<form action="ins_CodeKind.do" method="post" name="form1" onsubmit="return saveinfo()">
<div id="body_div">
	<w:ShowTitle name="添加字典码大类">
  ...
  <table width="100%">
    ...
    <tr>
	   <td>字典大类名称</td>
	   <td class="left_align"><input type="text" name="codeKind.kindName"  maxlength="40"/></td>
    </tr>
    <tr>
	   <td>字典大类字母代码</td>
	   <td class="left_align"><input type="text" name="codeKind.kindCode" maxlength="40"/></td>
    </tr>
    <tr>
	   <td>可扩展层级数</td>
	   <td class="left_align"><input type="text" name="codeKind.levelTal"  maxlength="1"/></td>
    </tr>
    <tr>
	   <td>所属模块</td>
	   <td class="left_align"><input type="text" name="codeKind.codeType"/></td>
    </tr>
	<tr>
		<td>备&nbsp;注</td>
        <td class="left_align"><textarea name="codeKind.remark" rows="5"   cols="80" > </textarea></td>
	</tr>
</table>
</div>
</div>
