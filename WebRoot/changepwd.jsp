...
<div class="pageContent">
	...
	<form method="post" action="updatePasswordUser.do" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)">
		<div class="pageFormContent" layoutH="58">
			<div class="unit">
				<label>用户ID：</label>
				<input type="text" name="userId" size="30" maxlength="20" class="required" value="${param.userId}" readonly="readonly"/>
			</div>
			<div class="unit">
				<label>旧密码：</label>
			...
			<div class="unit">
				<label>新密码：</label>
				<input type="password" id="cp_newPassword" name="newPassword" size="30" minlength="4" maxlength="20" class="required alphanumeric"/>
			</div>
			<div class="unit">
				<label>重复输入新密码：</label>
